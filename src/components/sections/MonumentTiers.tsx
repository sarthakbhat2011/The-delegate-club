...
const tiers: Tier[] = [
  ...
  },
  {
    ...
    description: "Diplomatic Model UN simulations, high-adrenaline hackathons, exclusive networking socials, and live entrepreneurial pitches.",
  ...
  },
  {
    ...
    description: "A digital gallery showcasing moments from our past assemblies, networking galas, elite auctions, and prestigious guest lectures.",
