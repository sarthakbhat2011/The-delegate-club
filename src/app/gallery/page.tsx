        ...
        <section className="relative pt-36 pb-8 px-4 md:px-8">
          <div className="max-w-7xl mx-auto text-center relative z-10">
            ...
            <h1 className="text-4xl md:text-6xl font-black uppercase tracking-tight mb-2">
              <span className="bg-gradient-to-r from-rose-500 to-amber-500 bg-clip-text text-transparent">The Sabha Gallery</span>
            </h1>
          ...
          <div className="stained-glass border border-black/10 dark:border-white/10 rounded-2xl flex flex-col min-h-[520px] shadow-2xl overflow-hidden">
            ...
            <div className="px-4 py-2 flex justify-between items-center text-white bg-gradient-to-r from-amber-500 to-yellow-500 shadow-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-black uppercase tracking-widest text-white">ARCHIVE_EXPLORER.EXE // Image browser</span>
              </div>
            ...
            <div className="bg-white/40 dark:bg-zinc-950/40 backdrop-blur-md px-4 py-2 border-b border-black/5 dark:border-white/5 flex gap-4 text-[10px] font-sans text-black dark:text-zinc-300 font-black uppercase tracking-wider select-none">
              ...
              <span className="hover:text-amber-500 cursor-pointer">View</span>
              <span className="hover:text-amber-500 cursor-pointer">Go</span>
            ...
            <div className="flex-grow bg-white/50 dark:bg-zinc-950/50 backdrop-blur-md p-4 flex flex-col md:flex-row gap-4 min-h-0 border-t border-black/5 dark:border-white/5">
              ...
              <div className="md:w-1/4 bg-white/40 dark:bg-zinc-900/40 backdrop-blur-md border border-black/10 dark:border-white/10 rounded-xl p-3 flex flex-col justify-between gap-4 overflow-y-auto">
                ...
                <div className="bg-amber-500/5 dark:bg-amber-500/2 p-2 rounded-xl border border-amber-500/10 font-mono text-[9px] text-amber-600 dark:text-amber-400 space-y-1 mt-auto">
              ...
              <div className="flex-grow flex flex-col min-h-0 bg-white/40 dark:bg-zinc-900/40 backdrop-blur-md border border-black/10 dark:border-white/10 rounded-xl p-4 relative overflow-y-auto">
                <div className="relative z-10">
                  <div className="flex justify-between items-center border-b border-black/5 dark:border-white/5 pb-2 mb-4">
                    ...
                    <span className="text-[9px] font-sans text-zinc-500 dark:text-zinc-400 font-black uppercase tracking-wider">
                      Files Mapped: {filteredImages.length}
                    </span>
                  </div>

                  {filteredImages.length === 0 ? (
                    <div className="text-center py-16 font-sans text-xs text-zinc-400 font-bold uppercase tracking-wider">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                      {filteredImages.map((img) => (
                        <div
                          ...
                          className="p-2.5 bg-white/60 dark:bg-zinc-900/60 border border-black/10 dark:border-white/10 rounded-2xl text-center hover:bg-white/80 dark:hover:bg-zinc-800/80 cursor-pointer shadow-sm hover:scale-103 transition-all duration-300"
                        >
                          <div className="relative aspect-square rounded-xl overflow-hidden bg-black flex items-center justify-center border border-black/5 dark:border-white/5">
                            <img 
                              src={img.src} 
                              alt={img.title} 
                          ...
                          <div className="mt-2 text-left font-sans text-[10px] font-black uppercase tracking-wider text-foreground flex justify-between items-center">
                            <span className="block truncate max-w-[80%]">📁 {img.fileName}</span>
                            <span className="text-zinc-500 text-[8px] tracking-normal font-semibold">Size: {img.size}</span>
                          </div>
                        </div>
                      ))}
                    </div>
          ...
          {selectedImage && (
            <div className="fixed inset-0 z-[100] bg-black/60 backdrop-blur-md flex items-center justify-center p-4">
              <motion.div
                ...
                className="w-full max-w-3xl stained-glass border border-black/10 dark:border-white/10 rounded-2xl overflow-hidden shadow-2xl flex flex-col"
              >
                {/* Dialogue Header */}
                <div className="px-4 py-2 flex justify-between items-center text-white bg-gradient-to-r from-rose-500 to-amber-500 shadow-sm select-none">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-black uppercase tracking-widest">DIALOG // VIEWING {selectedImage.fileName}</span>
                  </div>
                  <button 
                ...
                {/* Dialogue Body */}
                <div className="p-4 bg-white/50 dark:bg-zinc-950/50 backdrop-blur-md flex flex-col gap-4 border-t border-black/5 dark:border-white/5 text-foreground">
                  <div className="relative aspect-video rounded-xl border border-black/5 dark:border-white/5 overflow-hidden bg-black flex items-center justify-center shadow-md">
                    <img 
                  ...
                  <div className="bg-black/5 dark:bg-white/5 p-4 rounded-xl border border-black/5 dark:border-white/5 font-mono text-[10px] space-y-2 shadow-inner">
                    {isEditing ? (
                      <div className="space-y-2">
                        <div className="flex flex-col sm:flex-row gap-2">
                          <div className="flex-grow">
                            <label className="text-[8px] text-zinc-500 uppercase block font-bold">File Name:</label>
                            <input 
                              type="text"
                              value={editFileName}
                              onChange={(e) => setEditFileName(e.target.value)}
                              className="w-full bg-white dark:bg-zinc-900 border border-black/10 dark:border-white/10 px-2 py-1 rounded-lg text-[10px] text-foreground"
                            />
                          </div>
                          <div className="w-full sm:w-1/3">
                            <label className="text-[8px] text-zinc-500 uppercase block font-bold">Category:</label>
                            <select 
                              value={editCategory}
                              onChange={(e) => setEditCategory(e.target.value)}
                              className="w-full bg-white dark:bg-zinc-900 border border-black/10 dark:border-white/10 px-2 py-1 rounded-lg text-[10px] text-foreground"
                            >
                              <option value="MUN" className="dark:bg-zinc-900">MUN</option>
                              <option value="Hackathon" className="dark:bg-zinc-900">Hackathon</option>
                              <option value="Socials" className="dark:bg-zinc-900">Socials</option>
                              <option value="Auctions" className="dark:bg-zinc-900">Auctions</option>
                            </select>
                          </div>
                        </div>

                        <div>
                          <label className="text-[8px] text-zinc-500 uppercase block font-bold">Title (Description):</label>
                          <input 
                            type="text"
                            value={editTitle}
                ...
                <div className="bg-zinc-300 dark:bg-zinc-900 px-4 py-3 border-t border-black/5 dark:border-white/5 flex justify-between items-center select-none">
                    ...
                    {isEditing ? (
                      <>
                        <button
                          ...
                          className="bg-emerald-600 hover:bg-emerald-700 text-white px-3 py-1.5 rounded-lg text-xs font-black uppercase tracking-widest shadow-sm hover:scale-105 active:scale-95 transition-all cursor-pointer flex items-center gap-1"
                        >
                          <Save className="w-3.5 h-3.5" /> Save Changes
                        </button>
                        <button
                          onClick={() => setIsEditing(false)}
                          className="bg-white/40 dark:bg-zinc-900/40 border border-black/10 dark:border-white/10 text-black dark:text-zinc-300 px-3 py-1.5 rounded-lg text-xs font-black uppercase tracking-widest hover:scale-105 active:scale-95 transition-all cursor-pointer"
                        >
                          Cancel
                        </button>
                      </>
                      ...
                      <>
                        <button
                          ...
                          className="bg-amber-500 hover:bg-amber-600 text-white px-3 py-1.5 rounded-lg text-xs font-black uppercase tracking-widest shadow-sm hover:scale-105 active:scale-95 transition-all cursor-pointer flex items-center gap-1"
                        >
                          <Edit3 className="w-3.5 h-3.5" /> Edit details
                        </button>
                        <button
                          onClick={() => handleDeleteImage(selectedImage.id)}
                          className="bg-rose-600 hover:bg-rose-700 text-white px-3 py-1.5 rounded-lg text-xs font-black uppercase tracking-widest shadow-sm hover:scale-105 active:scale-95 transition-all cursor-pointer flex items-center gap-1"
                        >
                  ...
                  <button
                    onClick={() => setSelectedImage(null)}
                    className="bg-white/40 dark:bg-zinc-900/40 border border-black/10 dark:border-white/10 text-black dark:text-zinc-300 px-4 py-1.5 rounded-lg text-xs font-black uppercase tracking-widest hover:scale-105 active:scale-95 transition-all cursor-pointer"
                  >
                    Close [Esc]
                  </button>
                </div>
