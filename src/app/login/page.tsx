...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-transparent flex items-center justify-center relative overflow-hidden px-4 select-none">
      ...
      <Link href="/" className="absolute top-8 left-8 text-foreground hover:text-rose-500 transition-colors z-20 font-mono tracking-widest text-xs uppercase flex items-center gap-1">
